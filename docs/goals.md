...
- **Brewing Equipment Setup**: 
  -  abilty  to add multiple sensors from sources (w1, other)
  -  identifty and map Hardware Controllers and give nickname
  -  ability to add link sensor to controlled devices(kettle, pump, fridge)
